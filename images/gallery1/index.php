<?php
	...
	*/
	...
	define("TEXT_GALLERY_NAME", "Galeria de Arcos");
	define("TEXT_HOME", "Galeria de Arcos");
	define("TEXT_CLOSE_IMG_VIEW", "Fechar Imagem");
	define("TEXT_ACTUAL_SIZE", "Tamanho real");
	define("TEXT_FULLRES", "Resolução completa");
	define("TEXT_PREVIOUS", "<< Anterior");
	define("TEXT_NEXT", "Próxima >>");
	define("TEXT_INFO", "Informações");
	define("TEXT_DOWNLOAD", "Baixar imagem");
	define("TEXT_NO_IMAGES", "Nenhuma imagem nesta galeria");
	define("TEXT_DATE", "Data");
	define("TEXT_FILESIZE", "Tamanho do arquivo");
	define("TEXT_IMAGESIZE", "Imagem completa");
	define("TEXT_DISPLAYED_IMAGE", "Imagem exibida");
	define("TEXT_DIR_NAME", "Nome da Galeria");
	define("TEXT_IMAGE_NAME", "Nome da Imagem");
	define("TEXT_FILE_NAME", "Nome do Arquivo");
	define("TEXT_DIRS", "Sub-galerias");
	define("TEXT_IMAGES", "Imagens");
	define("TEXT_IMAGE_NUMBER", "Imagem número");
	define("TEXT_FILES", "Arquivos");
	define("TEXT_DESCRIPTION", "Descrição");
	define("TEXT_DIRECT_LINK_GALLERY", "Link direto para a galeria");
	define("TEXT_DIRECT_LINK_IMAGE", "Link direto para a imagem");
	define("TEXT_NO_PREVIEW_FILE", "Nenhum previsão para a imagem");
	define("TEXT_IMAGE_LOADING", "Carregando imagem ");
	define("TEXT_LINKS", "Links");
	define("TEXT_NOT_SCALED", "Não escalada");
	define("TEXT_LINK_BACK", "Voltar ao site");
	define("TEXT_THIS_IS_FULL", "Completa");
	define("TEXT_THIS_IS_PREVIEW", "Amostra");
	define("TEXT_SCALED_TO", "Escalada à");
	define("TEXT_YES", "Sim");
	define("TEXT_NO", "Não");
	define("TEXT_EXIF_DATE", "EXIF Data");
	define("TEXT_EXIF_CAMERA", "Camera");
	define("TEXT_EXIF_ISO", "ISO");
	define("TEXT_EXIF_SHUTTER", "Velocidade do Shutter");
	define("TEXT_EXIF_APERTURE", "Abertura");
	define("TEXT_EXIF_FOCAL", "Distância Focal");
	define("TEXT_EXIF_FLASH", "Flash disparado?");
	define("TEXT_EXIF_MISSING", "Nenhuma informação EXIF na imagem");
	...
	function sfpg_javascript()
	{
		...
		function showMenu()
		{
			...
			echo "menu += '<span onmouseover=\"this.className=\'sfpg_button_hover\';\" onmouseout=\"this.className=\'sfpg_button\';\" class=\"sfpg_button\" onclick=\"window.location=\'http://brasilbows.comeze.com/index.php\'\">Voltar à Brasilbows</span>';
